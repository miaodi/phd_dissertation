...
\byustylesetup{%
    ...
    keywords = {isogeometric analysis, patch coupling, dual mortar method, \Bezier dual basis, polynomial reproduction, Kirchhoff-Love shell, kink, locking, $\bar{B}$ projection} % your keywords
}
...
\title{Isogeometric \Bezier Dual Mortaring and Applications}
...
\include{exampleFiles/chapter1}
\include{exampleFiles/chapter2}
\include{exampleFiles/chapter3}
\include{exampleFiles/chapter4}
\include{exampleFiles/chapter5}
\include{exampleFiles/chapter6}
\include{exampleFiles/chapter7}
...
\appendix
% \include{exampleFiles/appendixa}
% \include{exampleFiles/appendixb}
